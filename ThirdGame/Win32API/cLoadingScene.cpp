...
void cLoadingScene::LoadingImage()
{
	...
	/* 전체 배경 */
	g_pImageManager->ReleaseImage("Map");
	g_pImageManager->ReleaseImage("Map_Magenta");
	g_pImageManager->ReleaseImage("HpBarBack");
	g_pImageManager->ReleaseImage("HpBarFront");
	g_pImageManager->ReleaseImage("fill");
	g_pImageManager->ReleaseImage("magenta");
	g_pImageManager->ReleaseImage("bar");
	g_pImageManager->ReleaseImage("MarioRight");
	g_pImageManager->ReleaseImage("MarioRight2");
	g_pImageManager->ReleaseImage("MarioLeft");
	g_pImageManager->ReleaseImage("MushRoom");
	g_pImageManager->ReleaseImage("Flower");
	g_pImageManager->ReleaseImage("ItemMushRoom");


	/* 맵 */
	g_pImageManager->ReleaseImage("BackGround");
	g_pImageManager->ReleaseImage("Map");
	g_pImageManager->ReleaseImage("ProgressBack");
	g_pImageManager->ReleaseImage("ProgressFront");
	g_pImageManager->ReleaseImage("Player");
	g_pImageManager->ReleaseImage("Player2");
	g_pImageManager->ReleaseImage("Bomb");


	g_pImageManager->ReleaseImage("2");
	g_pImageManager->ReleaseImage("4");
	g_pImageManager->ReleaseImage("16");
	g_pImageManager->ReleaseImage("32");
	g_pImageManager->ReleaseImage("8");
	g_pImageManager->ReleaseImage("64");
	g_pImageManager->ReleaseImage("128");
	g_pImageManager->ReleaseImage("256");
	g_pImageManager->ReleaseImage("512");
	g_pImageManager->ReleaseImage("1024");
	g_pImageManager->ReleaseImage("2048");
	g_pImageManager->ReleaseImage("Number");
	/* ====================== */
