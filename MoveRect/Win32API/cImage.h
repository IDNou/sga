...
public:
	...
	void AlphaRender(HDC hdc, int destX, int destY, int frameX, int frameY, BYTE alpha);
	...
	void FrameRender(HDC hdc, int destX, int destY, int sourX, int sourY, int FrameWidth, int FrameHeight);
	void FrameRender(HDC hdc, int destX, int destY,
